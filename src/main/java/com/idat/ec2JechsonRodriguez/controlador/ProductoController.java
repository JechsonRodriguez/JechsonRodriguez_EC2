...
import com.idat.ec2JechsonRodriguez.servicio.ProductoServ;
...
public class ProductoController {
    ...
    public ResponseEntity<List<ProductoRes>> getAll() {
        try {
            List<ProductoRes> items = new ArrayList<ProductoRes>();
    ...
    @GetMapping("{id}")
    public ResponseEntity<ProductoRes> getById(@PathVariable("id") int id) {
    	ProductoRes item = repository.obtenerId(id);
    ...
    @PatchMapping("{id}")
    public ResponseEntity<Void> update(@PathVariable("id") int id, @RequestBody ProductoReq item) {
        ProductoRes existingItem = repository.obtenerId(id);
